...
knitr::include_graphics('vscode_liveshare/1_extension2.png')
```
...
```{r echo = FALSE, fig.align = "center", out.width = "100%"}
knitr::include_graphics('vscode_liveshare/2_signin2.png')
```

"Authorize VisualStudioLiveShare" and accept ALL OF THE THINGS...

```{r echo = FALSE, fig.align = "center", out.width = "100%"}
knitr::include_graphics('vscode_liveshare/3_authorize2.png')
```
...
```{r echo = FALSE, fig.align = "center", out.width = "100%"}
knitr::include_graphics('vscode_liveshare/4_bottom2.png')
```
...
```{r echo = FALSE, fig.align = "center", out.width = "100%"}
knitr::include_graphics('vscode_liveshare/5_panel2.png')
```
...
```{r echo = FALSE, fig.align = "center", out.width = "100%"}
knitr::include_graphics('vscode_liveshare/6_contacts2.png')
```
