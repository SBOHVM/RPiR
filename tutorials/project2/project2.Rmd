...
`plot_populations()` in the `RPiR` package, which does some work and then 
...
(Simpson diversity). Again, your function code should be documented, so 
remember to build the documentation for the package.
...
multiplication and division, then the addition and subtraction). So for
$a^{\frac{b}{c+d}}$, you calculate $c+d$ because they are on a line of their 
own, then
