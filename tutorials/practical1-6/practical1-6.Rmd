...
you'll need to create a repository in the IBAHCM organisation on GitHub.

## GitHub

First you'll need to create a repository in the IBAHCM organisation on GitHub.
You'll find instructions on how to do this
[here](https://ibahcm.github.io/RPiR/articles/pages/github.html). Call this
repository `githubusername_series01` (obviously use your real GitHub username!). 
...
repository using the instructions [here](https://ibahcm.github.io/RPiR/articles/pages/rstudio.html).
...
Find the `IBAHCM/rpir21` team (that's you guys) - by searching for `rpir21`.
Make sure <span style="color: #de77ae;">Read</span> access is selected and
<span style="color: #de77ae;">Add IBAHCM/rpir21 to this repository</span>.
...
https://github.com/IBAHCM/louisematthews_series01. Remember to take a look at
