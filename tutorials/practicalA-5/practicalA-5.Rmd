...
https://github.com/IBAHCM/practicalA5 if you want to look at it there instead,
or you can install it locally on your computer using
`devtools::install_github("IBAHCM/practicalA5")` and play with the functions. Or
you can download it by cloning the git repo at
`https://github.com/IBAHCM/practicalA5.git`.
