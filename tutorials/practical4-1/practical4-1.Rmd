...
connected to GitHub as a repo in the `SBOHVM` organisation. Remember that
a guide to creating packages on GitHub is available on the `RPiR` help pages
[here](https://sbohvm.github.io/RPiR/articles/pages/packages_guide.html) if
...
created). Specifically, the `bci_quadrats` data frame translates the column
names in `bci_2010` into actually rows and columns in a grid or `(x,y)`
...
[here](https://sbohvm.github.io/RPiR/articles/pages/packages_guide.html#add-dependencies)
...
[here](https://sbohvm.github.io/RPiR/articles/pages/packages_guide.html#package-documentation).
...
[here](https://sbohvm.github.io/RPiR/articles/pages/packages_guide.html#add-data).
...
your package using `devtools::install_github("SBOHVM/githubusernameBCI")` (or
