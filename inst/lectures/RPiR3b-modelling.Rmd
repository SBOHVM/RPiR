...
<center>![](RPiR3b/a.png){ width=80% }</center>

## $R_0 > 1$

<center>![](RPiR3b/1.png){ width=80% }</center>
  
## $R_0 > 1$

<center>![](RPiR3b/2.png){ width=80% }</center>

## $R_0 > 1$

<center>![](RPiR3b/3.png){ width=80% }</center>

## $R_0 > 1$

<center>![](RPiR3b/4.png){ width=80% }</center>

## $R_0 > 1$

<center>![](RPiR3b/5.png){ width=80% }</center>
...
<center>![](RPiR3b/b.png){ width=80% }</center>

## $R_0 < 1$

<center>![](RPiR3b/c.png){ width=80% }</center>

## $R_0 < 1$

<center>![](RPiR3b/d.png){ width=80% }</center>
...
<center>![](RPiR3b/graph.png){ width=60% }</center>
...
<center>![](RPiR3b/structure.png){ width=100% }</center>

</div>

## SIR process {.flexbox .vcenter}

<center>![](RPiR3b/process.png){ width=80% }</center>
...
<center>![](RPiR3b/sis.png){ width=80% }</center>
...
<center>![](RPiR3b/one.png){ width=60% }</center>

## Epidemic dynamics for $R_0 = 2$

<center>![](RPiR3b/two.png){ width=60% }</center>

## Epidemic dynamics for $R_0 = 2$

<center>![](RPiR3b/three.png){ width=60% }</center>

## Epidemic dynamics for $R_0 = 2$

<center>![](RPiR3b/four.png){ width=60% }</center>

## Epidemic dynamics for $R_0 = 2$

<center>![](RPiR3b/five.png){ width=60% }</center>

## Epidemic dynamics for $R_0 = 2$

<center>![](RPiR3b/six.png){ width=60% }</center>

## Epidemic dynamics for $R_0 = 2$

<center>![](RPiR3b/seven.png){ width=60% }</center>
...
<center>![](RPiR3b/diminishing.png){ width=60% }</center>
...
<center>![](RPiR3b/sis_graph.png){ width=60% }</center>

## SIS simulation for $R_0 = 3$

<center>![](RPiR3b/sis_graph2.png){ width=60% }</center>
