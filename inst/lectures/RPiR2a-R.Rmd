...
<center>![](RPiR2a/how.png){ width=80% }</center>
...
<center>![](RPiR2a/xkcd.png){ width=100% }</center>
<p>
...
<center>![](RPiR2a/phdcomics.gif){ width=100% }</center>
<p>
http://phdcomics.com/comics/archive.php?comicid=946

## Starting with...

> - Practical 0.1 ("practical0-1") on functions and loops
