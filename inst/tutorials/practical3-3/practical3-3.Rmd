...
<span style="color: #de77ae;">d0302_stochastic_birth_death</span> more compact, and 
will also make it much less prone
to error, as we’ve isolated 10 more lines of code that we never need to write 
(or copy and paste) again. 

Note that there is a demo in {RPiR} that checks
