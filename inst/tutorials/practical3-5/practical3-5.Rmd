---
title: "Reproducible Programming in R Practical 3-5"
output: 
  learnr::tutorial:
    theme: lumen
...
Adapt the code from <span style="color: #de77ae;">0304-run-SIR.r</span> to make <span style="color: #de77ae;">0305-mean-SIR.r</span>. Try just 
adding the stochastic simulations from 3-4 together by adding the 
...
Go to the <span style="color: #1697C0;">boydorr/ProgInR</span> package on 
...
Try running the code with an $R_0$ of 2, and a variety of different numbers of initially infected animals. You should find that as we start with more initially
...
Write a report demonstrating stochastic extinction. Show different results 
