---
title: "1-1: Exponential growth model"
output: 
  learnr::tutorial:
    theme: lumen
    includes:
...
**instruction, but we can use curly brackets** `{ ... }` **to combine several** 
**lines so that they all get repeated**. Try it and see:
...
Finally, try copying the code into a *.R document in R Studio, saving it, and
generating a report from it. You can do this by clicking on 
<span style="color: #de77ae;">File</span> >
...
You'll start generating your own reports in Practical 1-6.
