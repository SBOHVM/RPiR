...
and then we can start the main loop. The variable `new.time` will count the 
...
really fancy try combining these outputs with `paste()` or `paste0()`. Try and 
...
timesteps which started at 1 onto timepoint 0. 
...
would any other piece of data in R. Try to run the following commands:
