...
You now need to create the processing files. Actually, we provide them here.
...
The latter is easy, and it is something you are going to have to keep up to
date as you develop any package -- you need to check which libraries you load
using `library(xxx)` in any script or demo, and which libraries you use by
...
file for the package in the <span style="color: #1697C0;">R</span> folder.
You'll see details on how to do that 
