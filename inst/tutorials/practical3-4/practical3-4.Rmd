...
output: 
  learnr::tutorial:
    theme: lumen
    includes:
      in_header: "css/google-font.html"
    css: "css/google-font.css"
...
`timestep_stochastic_birth_death()` to handle the 
SIS model rather than exponential growth. 
...
timestep_stochastic_SIS <- function(latest, transmission.rate, recovery.rate, timestep=1)
{
