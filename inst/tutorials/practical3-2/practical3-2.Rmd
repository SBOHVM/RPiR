...
Remember that, to test your function works you can run `devtools::load_all()` to
temporarily load your package into the Global environment. Then, once you're 
happy with your function, run `devtools::document()` to generate
