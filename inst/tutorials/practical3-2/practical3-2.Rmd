...
birth-death population dynamics from Practical 1-5 -- in {githubusername} as a 
template. 
...
`plot_populations()`, and `library(githubusername)` to load `timestep_stochastic_birth_death()`, which means you 
...
dynamics (from Practical 1-5). We've written this function into {githubusername} as
