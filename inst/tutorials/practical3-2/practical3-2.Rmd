...
your report (in your
<span style="color: #de77ae;">demo/d0302_stochastic_birth_death.R</span> demo file). Remember that you can run your code by compiling a notebook or by running it as a demo, 
...
Run the code several times with a birth rate of 0.2, a death rate of 0.1, 
and an initial population count of 1. Since we're repeating the piece of
code doing the simulation, you could do this using a `for` loop. The 
