...
<span style="color: #1697C0;">IBAHCM/ProgInR</span> package on GitHub.

## Tasks

You have been provided with a new package on GitHub at https://github.com/IBAHCM/ProgInR. Take a look at this code online and read the
...
from the model more cleanly. Install the package using `devtools::install_github("IBAHCM/ProgInR")`. Then take a look at the new 
function `run_simple()` online. Go to <span style="color: #1697C0;">https://github.com/IBAHCM/ProgInR</span>, open on the 
<span style="color: #1697C0;">R</span> folder, and open the file called 
...
Now rewrite <span style="color: #de77ae;">0301-run-birth-death.r</span> as <span style="color: #de77ae;">0302-run-birth-death.r</span> using
...
<span style="color: #de77ae;">0302-run-birth-death.r</span> more compact, and will also make it much less prone
