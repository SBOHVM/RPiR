...
We’ll start by writing the structural code (in <span style="color: #de77ae;">0301-run-birth-death.r</span>). From
Practicals 2-3 and 2-4 we have a `while()` loop which runs the simulation 
(remember that we are back to the birth-death population dynamics from 1-5 
though):
