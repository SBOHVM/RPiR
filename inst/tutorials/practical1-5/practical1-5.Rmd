...
description: "Reproducible Programming in R Practical 1-5!"
---
...
which we can state roughly in English as "*the next population size is the current size plus the new additions (lambda times the current size)*", and this can be rewritten in turn in R as:
...
<span style="color: #de77ae;">0104-step-growth.r</span> appropriately.

For convenience, here's a slightly adapted version of
<span style="color: #de77ae;">0104-step-growth.r</span>, which we've renamed as 
<span style="color: #de77ae;">0105-step-birth-death.r</span>. Try to fill in the 
blanks:
...
and here's a copy of <span style="color: #de77ae;">0104-run-growth.r</span>, 
which we've renamed as 
<span style="color: #de77ae;">0105-run-birth-death.r</span>. Again,`source()`
